...
class CheckMacroArgumentsDescriptionPopulated(BaseCheck):
    name: Literal["check_macro_arguments_description_populated"] = Field(default=None)

    @pytest.mark.iterate_over_macros
    def check_macro_arguments_description_populated(
        self, request, check_config=None, macro=None
    ) -> None:
        """
...
class CheckMacroDescriptionPopulated(BaseCheck):
    name: Literal["check_macro_description_populated"] = Field(default=None)

    @pytest.mark.iterate_over_macros
    def check_macro_description_populated(self, request, check_config=None, macro=None) -> None:
        """
...
class CheckMacroNameMatchesFileName(BaseCheck):
    name: Literal["check_macro_name_matches_file_name"] = Field(default=None)

    @pytest.mark.iterate_over_macros
    def check_macro_name_matches_file_name(self, request, check_config=None, macro=None) -> None:
        """
