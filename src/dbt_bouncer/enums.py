...
class ModelRuleCode(StrEnum):
    ...
    CHECK_MODEL_ALIAS = "MO058"
    CHECK_MODEL_CODE_DOES_NOT_CONTAIN_REGEXP_PATTERN = "MO007"
    CHECK_MODEL_COLUMN_DESCRIPTION_POPULATED = "MO054"
    CHECK_MODEL_COLUMN_HAS_SPECIFIED_TEST = "MO053"
    CHECK_MODEL_COLUMN_NAME_COMPLIES_TO_COLUMN_TYPE = "MO055"
    CHECK_MODEL_COLUMN_NAMES = "MO057"
    CHECK_MODEL_COLUMN_TYPE_COMPLIES_TO_COLUMN_NAME = "MO056"
    ...
    CHECK_MODEL_DOES_NOT_USE_CARTESIAN_JOIN = "MO052"
