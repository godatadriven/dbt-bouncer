-- these macros will read a user’s home environment and detect whether a computer’s
-- operating system is Windows based or Mac/Linux, and display the right directory
-- pattern.
