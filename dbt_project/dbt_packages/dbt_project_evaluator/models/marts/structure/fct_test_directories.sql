with
    ...
    models_per_test as (
        ...
        from relationships
        where resource_type = 'test' and is_primary_test_relationship
    ...
    model_file_paths as (
        ...
        from resources
        inner join
            models_per_test on models_per_test.parent_model_id = resources.resource_id
    ...
    test_file_paths as (
        ...
        from resources
        where resource_type = 'test' and is_generic_test
    ...
    all_file_paths as (
        ...
        inner join test_file_paths on model_file_paths.test_id = test_file_paths.test_id
...
select *
from different_directories {{ filter_exceptions() }}
