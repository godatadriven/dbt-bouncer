...
> **Removed in v4:** class-based checks (subclassing `BaseCheck` directly) are no longer discovered by the runner. Migrate to the decorator API above — see [Adding a new check](../CONTRIBUTING.md#adding-a-new-check).
