...
Class-based checks remain supported but are a legacy escape hatch — prefer the decorator API above. If you do subclass `BaseCheck`, two things commonly trip people up:
