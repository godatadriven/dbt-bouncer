...
> **Upgrading past v3?** Several of the APIs described below changed again in v4. This guide documents the v2 → v3 migration only; see [Migrating to v4.0.0](v4.md) for what v4 renames, removes and rejects.
